$(function() {
        ...
        $(window).scroll(function() {
          if ($(this).scrollTop() > 200) $('.navbar-right').css({
            'animation-name': 'ml',
            'animation-duration': '1.5s',
            'animation-fill-mode': 'forwards'
          });
          else $('.navbar-right').css({
            'animation-name': 'mr',
            'animation-duration': '1.5s',
            'animation-fill-mode': 'forwards'
          });
        ...
        $(".portfolio_item").each(function(i) {
          ...
          $(this).find(".port").prop("id", "port_" + i);
        });
        ...
        var myArray = ["раз", "два", "три", "четыре", "пять", 6 , s ]
          $.each(myArray, function(index, value) {
            console.log("INDEX: " + index + " VALUE: " + value);
          });

          $('a').each(function(i, val) {
            console.log(i + ':' +  $(this).text(), '(href=' + $(this).attr('href') + ')');
          });
